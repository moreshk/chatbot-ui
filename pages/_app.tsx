...
function App({ Component, pageProps }: AppProps<{}>) {
  ...
  console.log("Business name:", business_name);
    ...
    // Create the string
    const myString = `You are ${name}, an AI enabled business sales representative for ${business_name} , ${about_us}.
    Your job is to collect requirements from potential business clients who chat with you. Start each conversation with a: Hey, welcome to ${business_name}. How can I help you today? 
    ...
    You have to collect data points from the clients for the following: ${questionsString}.
